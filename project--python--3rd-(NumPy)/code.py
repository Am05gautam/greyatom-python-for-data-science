...
len_3= len(race_3)
len_4= len(race_4)
length_race= np.array([len_0,len_1,len_2,len_3,len_4])
# print(length_race[np.min(length_race)])
# print(np.where(length_race==length_race.min()))
minority_race= length_race.argmin()
print(minority_race)
